...
describe("Essentials PA Tests", function () {
  it("test for passing", async function () {
    ...
    try {
      await driver.get("https://content.atis.army.mil/#/");
      const originalWindow = await driver.getWindowHandle();
      await driver.findElement(By.id("sso-button")).click();

      await driver.wait(until.elementLocated(By.id("details-button")), 200000);
      await driver.findElement(By.id("details-button")).click();
      await driver.findElement(By.id("proceed-link")).click();

      await driver.wait(
        until.elementLocated(By.css(".warn-modal-box button")),
        200000,
      );
      await driver.findElement(By.css(".warn-modal-box button")).click();
      await driver.findElement(By.id("pki-login")).click();

      await driver.wait(until.elementLocated(By.linkText("Courses")), 200000);
      await driver.get(
        "https://content.atis.army.mil/#/content/courses/4203/version/12/logs",
      );
      await driver.wait(
        until.elementLocated(By.linkText("Test & Configure")),
        150000,
      );
      await driver.findElement(By.linkText("Test & Configure")).click();
      ...
      await driver.wait(until.elementLocated(By.linkText("Debug Logs"), 10000));
      await driver.findElement(By.linkText("Debug Logs")).click();
      await driver.findElement(By.css("button#share-log-button")).click();
      const log_link = await driver
        .findElement(By.id("log-link"))
        .getAttribute("href");
...
async function runTest(driver, score) {
  await driver.wait(
    until.elementLocated(By.css("button#landing_next")),
    100000,
  );
