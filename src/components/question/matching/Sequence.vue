...
<template>
  <Base :questionData :answer>
    <div
      class="flex h-full w-full flex-col items-center gap-6 lg:flex-row lg:gap-2">
      <div class="flex h-full w-full flex-col gap-4">
        <Drop
          ...
          <template #item>
            <Drag
              :id="item"
              className="h-14 rounded-sm flex items-center justify-center bg-saffron p-1 font-bold text-oxfordblue text-sm">
              {{ item }}
            </Drag>
          </template>
        </Drop>
