...
const questionData = {
  id: 0,
  scenario: 1,
  query: "Select the first step, then click next",
  type: "performance",
  responses: [
    {
      content: "Select the first step",
      value: "{order_matters=true}[.]clicked I accept",
    },
  ],
};
...
onBeforeUnmount(() => {
  questions.saveLearnerActions();
});
</script>
<template>
  <Simulation :questionData :actions>
    <div class="flex h-full w-full items-center justify-center bg-[#fff] p-4">
      <div
        class="flex w-[65dvw] flex-col gap-2 border-2 border-[#cbcbcb91] bg-gradient-to-b from-[#ffffff] via-[#e9ecf0] to-[#ededf5ba] p-4 text-xs font-bold">
        <h2 class="font-bold uppercase">
          You are accessing a u.s. government (usg) information system (is) that
          is provided for USG-Authorized use only.
        </h2>
        <p class="font-normal">
          By using this IS (which is includes device attached to this IS), you
          consent to the following conditions:
        </p>
        <ul class="ml-2 flex list-['►'] flex-col font-normal">
          <li class="p-2">
          ...
          <li class="p-2">
            At any time, the USG may ispect and seize data stored on this IS.
          </li>
          <li class="p-2">
          ...
          <li class="p-2">
            ...
            are private and confidential. See <a href="">User Agreement</a> for
            details.
          </li>
        </ul>
        <button
